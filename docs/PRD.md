...
#### ❌ ELIM (Elimination) - 탈락 정보 (v11.16.0 업데이트)
...
- **출력 예시**:
  ...
  - 상금 있음:
    ```
    JOHN DOE / US
    ELIMINATED IN 5TH PLACE $10,000
    ```
- **주요 변경** (v11.16.0):
  - 순위 자동 서수 변환 (5 → 5TH, 1 → 1ST, 2 → 2ND, 3 → 3RD)
  - 상금 자동 포맷 (50000 → $50,000)
...
### v11.16.0 (2025-01-20) ✅ **최신**
**🎨 UI 텍스트 간결화 & ELIM 모드 상금 기능 개선**
