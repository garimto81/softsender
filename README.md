...
### v11.4.0 (2025-01-16)
**🔒 SC 번호 중복 발급 문제 해결 (Lock 기반)**
- ✅ **LockService 도입**: 동시 요청 시 중복 번호 발급 방지
- ✅ **순차 증가 보장**: Lock으로 동시성 제어, 번호 건너뛰기 방지
- ✅ **캐시 제거**: 캐시 만료로 인한 번호 되돌아감 문제 해결
- ✅ **테스트 강화**: 순차 증가 검증 로직 추가
- 🎯 **안정성**: 여러 사용자 동시 업로드 시 번호 충돌 0%
